	...
	<div class="col-md-12 wow fadeInLeft">
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 <label for="product_productPrice" class="col-md-2 text-right">商品单价:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="product_productPrice" name="product.productPrice" class="form-control" placeholder="请输入商品单价">
					 </div>
				  </div>
				  <div class="form-group">
				  	 <label for="product_productCount" class="col-md-2 text-right">商品库存:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="product_productCount" name="product.productCount" class="form-control" placeholder="请输入商品库存">
					 </div>
				  </div>
				  <div class="form-group">
