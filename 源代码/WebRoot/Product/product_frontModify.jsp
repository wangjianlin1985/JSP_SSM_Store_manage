...
<jsp:include page="../header.jsp"></jsp:include>
	...
	<ul class="breadcrumb">
		...
		<div class="row"> 
		  ...
		  <div class="form-group">
		  	 <label for="product_productPrice_edit" class="col-md-3 text-right">商品单价:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_productPrice_edit" name="product.productPrice" class="form-control" placeholder="请输入商品单价">
			 </div>
		  </div>
		  <div class="form-group">
