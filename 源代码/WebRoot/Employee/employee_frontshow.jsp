...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Employee/frontlist">雇员信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">雇员编号:</div>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">雇员照片:</div>
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=employee.getRegTime()%></div>
	</div>
	<div class="row bottom15">
